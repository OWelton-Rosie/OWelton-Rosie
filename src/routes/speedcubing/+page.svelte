...
<p>Speedcubing (also known as speedsolving or cubing), is the competitive solving of <a href="https://en.wikipedia.org/wiki/World_Cube_Association#Events" target="_blank">Rubik's Cube-like puzzles</a>. Global speedcubing is sanctioned by the <a href="https://www.worldcubeassociation.org/" target="_blank">World Cube Association (WCA)</a>.</p>
...
<p>I use the <a href="https://www.speedcubereview.com/4look.html" target="_blank">4 Look Last Layer</a> method to solve the 3x3x3 Rubik's Cube in under 18 seconds on average. I am currently ranked in the top 100 in New Zealand for <a href="https://en.wikipedia.org/wiki/Pyraminx" target="_blank">Pyraminx</a> average and single. You can see all of the results I have achieved in competitions on my <a href="https://www.worldcubeassociation.org/persons/2023WELT02" target="_blank">WCA Profile</a>.</p>

<img src="./assets/ftopenPyra.png" alt="Me, shortly after dropping my Pyraminx PR single to 3.83 seconds" class="cubing-image">
<p class="cubing-caption"> Me, shortly after dropping my Pyraminx PR single to 3.83 seconds.</p>
